...
(() => {
  ...
  window.GB = { api, toast, go, openAuth, openBoost, openClaim, claimDaily, claimLucky, doBoost, refresh, setAvatar, submitAuth, logout, shareCode, claimTask, donate, createProfile, adminLogin, adminAction, copyText };
  ...
  function connectSSE() {
    ...
    es.addEventListener('boost', (e) => {
      ...
      refreshHeader();
      if (S.current === 'home' || S.current === 'discover') debounceRender();
    });
